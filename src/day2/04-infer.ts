...
// type MyArguments<Function extends (...args: any[]) => any> = Function extends (
//   ...args: infer CalculatedArguments
// ) => any
//   ? CalculatedArguments
//   : never;
...
// type GetMovieFunction = (request: { url: string }) => {
//   title: string;
//   duration: number;
// };
...
// type PromiseValue<PromiseInstance extends Promise<unknown>> =
//   PromiseInstance extends Promise<infer PromiseValue> ? PromiseValue : never;
